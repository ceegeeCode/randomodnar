...
subStr = '_2Conv2LayerLstm_flanks200_win3_filters64And256_stride1_overlap0_dropout00'
learningRate = 0.001
...
#                    
            ...
            def myGenerator(customFlankSize,batchSize, inclFrqModel_b, insertFrqModel_b, labelsCodetype):
                ...
                while 1:
                    X,Y = dataGen.genSamplesForDynamicSampling_I(nrSamples = batchSize, genomeArray = genomeArray, repeatArray = repeatArray, exonicArray = exonicArray, flankSize = customFlankSize, getOnlyRepeats_b = getOnlyRepeats_b, inclFrqModel_b = inclFrqModel_b,
    ...
    #                sizeInput = X.shape[1]
                    ...
                    elif inclFrqModel_b == 0 and leftRight_b == 1:
